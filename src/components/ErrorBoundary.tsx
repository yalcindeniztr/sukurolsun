...
class ErrorBoundary extends Component<Props, State> {
    ...
    public render() {
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-[#f0fdf4] text-slate-800 flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <button
                        ...
                        className="mt-6 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 rounded-xl text-white font-medium transition-colors"
                    >
                        Sayfayı Yenile
                    </button>
                </div>
